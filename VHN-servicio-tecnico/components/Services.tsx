        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {services.map((service) => (
            <div
              ...
              className="group relative bg-gray-50 rounded-[2.5rem] overflow-hidden cursor-pointer transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-200/50 shadow-xl shadow-slate-200"
            >
